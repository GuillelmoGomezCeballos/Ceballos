...
void optimalCuts3l_52x
(
 int     mH  	 = 1100,
 int thePlot = 0,
 TString bgdInputFile     = "ntuples_52x_5000ipb/backgroundB_3l.root",
 TString signalInputFile  = "ntuples_52x_5000ipb/hww125.root",
 TString dataInputFile    = "ntuples_52x_5000ipb/data_mit_3l.root",
 TString signalInputFile2 = "ntuples_52x_5000ipb/vhtt125.root",
 ...
 )
{
  ...
  if     (thePlot >=  8 && thePlot <=  8) {nBinPlot = 4; xminPlot = -1.0; xmaxPlot = 1.0;}
  ...
  else if(thePlot >= 19 && thePlot <= 19) {nBinPlot = 100; xminPlot = 50.0; xmaxPlot = 150.0;}
  ...
  else if(thePlot >= 32 && thePlot <= 33) {nBinPlot = 120; xminPlot = 0; xmaxPlot = 120.0;}
  ...
  else if(thePlot >= 37 && thePlot <= 38) {nBinPlot = 200; xminPlot = 0.0; xmaxPlot =  200.0;}
  ...
  else if(thePlot >= 45 && thePlot <= 45) {nBinPlot = 100; xminPlot = -5.0; xmaxPlot = 15.0;}
  ...
  TH1D* histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVUp	= (TH1D*) histo0->Clone(Form("histo_WH_htt_CMS_MVAWH_httStatBounding_8TeV_vh3lUp"));
  TH1D* histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVDown = (TH1D*) histo0->Clone(Form("histo_WH_htt_CMS_MVAWH_httStatBounding_8TeV_vh3lDown"));
  TH1D* histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVUp	= (TH1D*) histo0->Clone(Form("histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeV_vh3lUp"));
  TH1D* histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVDown = (TH1D*) histo0->Clone(Form("histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeV_vh3lDown"));
  TH1D* histo_WZ_CMS_MVAWZStatBounding_8TeVUp	        = (TH1D*) histo0->Clone(Form("histo_WZ_CMS_MVAWZStatBounding_8TeV_vh3lUp"));
  TH1D* histo_WZ_CMS_MVAWZStatBounding_8TeVDown	        = (TH1D*) histo0->Clone(Form("histo_WZ_CMS_MVAWZStatBounding_8TeV_vh3lDown"));
  TH1D* histo_ZZ_CMS_MVAZZStatBounding_8TeVUp	        = (TH1D*) histo0->Clone(Form("histo_ZZ_CMS_MVAZZStatBounding_8TeV_vh3lUp"));
  TH1D* histo_ZZ_CMS_MVAZZStatBounding_8TeVDown	        = (TH1D*) histo0->Clone(Form("histo_ZZ_CMS_MVAZZStatBounding_8TeV_vh3lDown"));
  TH1D* histo_Wjets_CMS_MVAWjetsStatBounding_8TeVUp     = (TH1D*) histo0->Clone(Form("histo_Wjets_CMS_MVAWjetsStatBounding_8TeV_vh3lUp"));
  TH1D* histo_Wjets_CMS_MVAWjetsStatBounding_8TeVDown   = (TH1D*) histo0->Clone(Form("histo_Wjets_CMS_MVAWjetsStatBounding_8TeV_vh3lDown"));
  TH1D* histo_Wgamma_CMS_MVAWgammaStatBounding_8TeVUp	= (TH1D*) histo0->Clone(Form("histo_Wgamma_CMS_MVAWgammaStatBounding_8TeV_vh3lUp"));
  TH1D* histo_Wgamma_CMS_MVAWgammaStatBounding_8TeVDown = (TH1D*) histo0->Clone(Form("histo_Wgamma_CMS_MVAWgammaStatBounding_8TeV_vh3lDown"));
  TH1D* histo_VVV_CMS_MVAVVVStatBounding_8TeVUp         = (TH1D*) histo0->Clone(Form("histo_VVV_CMS_MVAVVVStatBounding_8TeV_vh3lUp"));
  TH1D* histo_VVV_CMS_MVAVVVStatBounding_8TeVDown       = (TH1D*) histo0->Clone(Form("histo_VVV_CMS_MVAVVVStatBounding_8TeV_vh3lDown"));
  ...
  if(useTemplates == true){
    histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVUp   ->Rebin(rebinMVAHist);
    histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVDown ->Rebin(rebinMVAHist);
    histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVUp   ->Rebin(rebinMVAHist);
    histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVDown ->Rebin(rebinMVAHist);
    histo_WZ_CMS_MVAWZStatBounding_8TeVUp	    ->Rebin(rebinMVAHist);
    histo_WZ_CMS_MVAWZStatBounding_8TeVDown	    ->Rebin(rebinMVAHist);
    histo_ZZ_CMS_MVAZZStatBounding_8TeVUp	    ->Rebin(rebinMVAHist);
    histo_ZZ_CMS_MVAZZStatBounding_8TeVDown	    ->Rebin(rebinMVAHist);
    ...
    histo_VVV_CMS_MVAVVVStatBounding_8TeVUp	    ->Rebin(rebinMVAHist);
    histo_VVV_CMS_MVAVVVStatBounding_8TeVDown	    ->Rebin(rebinMVAHist);
  ...
  for (int i=0; i<nBgd; ++i) {
    ...
    double dRMin = 999.0; double mTW3 = 0.0; double type3l = 0.0; double mTFromW = 0.0; double ptlw = 0.0; double which3rdl = -1;
    if(bgdEvent.lid3_ != 0){
    ...
    bdtg = ((dRMin/4.0)-0.5)*2.0;if(bdtg >= 1.0) bdtg = 0.999; if(bdtg <= -1) bdtg = -0.999;
    ...
    if(channel == 700){ // HZ->qqlnll selection
      ...
      if(
         ...
         bgdEvent.njets_ >= 1 &&
	 massZMin < 20 &&
	 (bgdEvent.jet1_+bgdEvent.jet2_).M() > 40 && (bgdEvent.jet1_+bgdEvent.jet2_).M() < 150 &&
	 dRMin < 2.0 &&
	 1 == 1
	){
	passCuts = true;
    ...
    if(passCuts == true){
      ...
      double trigEff  = 1.0 - ((1.0-trigEff0)*(1.0-trigEff1)*(1.0-trigEff2));
	...
	//else if(fDecay == 5 || fDecay == 13){  
	  ...
	  add = add*nPUScaleFactor2012(fhDPUS4,(float)bgdEvent.npu_);

	  if(bgdEvent.dstype_ == SmurfTree::wgstar) add = add*WGstarScaleFactor(bgdEvent.type_,bgdEvent.met_);
	  fDecay                 = 3;
	  isSignalDecay          = false;
	  theWeight              = -1.0 * bgdEvent.scale1fb_*lumi*add*trigEff;
          bgdDecay[(int)fDecay] += theWeight;
      ...
      //else if(fDecay == 5 || fDecay == 13){
        if(bgdEvent.dstype_ == SmurfTree::wz) add = 0.89;
        if(bgdEvent.dstype_ == SmurfTree::wgamma && channel != 1300) add = 1.35;
	...
	if((bgdEvent.cuts_ & SmurfTree::Lep3FullSelection) == SmurfTree::Lep3FullSelection)
  	...
  	//if(bgdEvent.dstype_ == SmurfTree::www) add = bgdEvent.sfWeightPU_*bgdEvent.sfWeightEff_;
	...
	// add = 1.0;
	theWeight              = bgdEvent.scale1fb_*lumi*add*trigEff;
        bgdDecay[(int)fDecay] += theWeight;
        weiDecay[(int)fDecay] += theWeight*theWeight;
      }
      else {
      ...
      else if(thePlot ==45) myVar = bgdEvent.jet1Btag_;
      ...
      else if(thePlot ==54) myVar = bgdEvent.pTrackMet_;
  ...
  if(systInputFile != "" && useTemplates == true){
	...
	printf("--- reading syst event %5d of %5d\n",i,nSyst);
      ...
      else if(systEvent.dstype_ == SmurfTree::ggzz  	   ) fDecay = 18;
	...
	if(deltaPhiD[2]<TMath::Pi()/2) pmetD = pmetD * sin(deltaPhiD[2]);
      ...
      double pxzll = systEvent.dilep_.Px() + newMet*cos( systEvent.metPhi_);
      double pyzll = systEvent.dilep_.Py() + newMet*sin( systEvent.metPhi_);
      double mtHZZ = TMath::Power(sqrt(systEvent.dilep_.Pt()*systEvent.dilep_.Pt()+91.1876*91.1876)+
                                  sqrt(newMet       *newMet       +91.1876*91.1876),2)
		   -pxzll*pxzll-pyzll*pyzll;
      if(mtHZZ >0) mtHZZ = sqrt(mtHZZ); else mtHZZ = 0.0;

      double mtHWW = TMath::Power(sqrt(systEvent.dilep_.Pt()*systEvent.dilep_.Pt()+systEvent.dilep_.M()*systEvent.dilep_.M())+
                                  sqrt(newMet       *newMet       +systEvent.dilep_.M()*systEvent.dilep_.M()),2)
		   -pxzll*pxzll-pyzll*pyzll;
      if(mtHWW >0) mtHWW = sqrt(mtHWW); else mtHWW = 0.0;

      double pznunu = 91.1876*91.1876 - newMet*newMet;
      if(pznunu > 0) pznunu = sqrt(pznunu); else pznunu = 0.0;
      double mHZZ = (sqrt(systEvent.dilep_.P()*systEvent.dilep_.P()+systEvent.dilep_.M()*systEvent.dilep_.M())+91.1876)*
                    (sqrt(systEvent.dilep_.P()*systEvent.dilep_.P()+systEvent.dilep_.M()*systEvent.dilep_.M())+91.1876)-
                   -pxzll*pxzll-pyzll*pyzll-(systEvent.dilep_.Pz()+pznunu)*(systEvent.dilep_.Pz()+pznunu);
      if(mHZZ > 0) mHZZ = sqrt(mHZZ); else mHZZ = 0.001;

      double massZMin = 999.0; double massMin = 999.0; double mtQQLN = -1.0; double mQQLN = -1.0;
      double dRMin = 999.0; double which3rdl = -1; double type3l = 0.0;
	...
	massMin  = trilepton_info(1,systEvent.lep1_,systEvent.lep2_,systEvent.lep3_,
		                    ...
		                    systEvent.lid1_,systEvent.lid2_,systEvent.lid3_,
				    systEvent.mt1_ ,systEvent.mt2_ ,systEvent.mt3_);
        which3rdl   = trilepton_info(9,systEvent.lep1_,systEvent.lep2_,systEvent.lep3_,
                                    systEvent.lq1_ ,systEvent.lq2_ ,systEvent.lq3_,
		                    systEvent.lid1_,systEvent.lid2_,systEvent.lid3_,
				    systEvent.mt1_ ,systEvent.mt2_ ,systEvent.mt3_);
        type3l= trilepton_info(4,systEvent.lep1_,systEvent.lep2_,systEvent.lep3_,
		                 ...
		                 systEvent.lid1_,systEvent.lid2_,systEvent.lid3_,
				 systEvent.mt1_ ,systEvent.mt2_ ,systEvent.mt3_);
	double pQQLN[5] = {systEvent.jet1_.Px() + systEvent.jet2_.Px() + newMet*cos( systEvent.metPhi_),
                           systEvent.jet1_.Py() + systEvent.jet2_.Py() + newMet*sin( systEvent.metPhi_),
			   systEvent.jet1_.Pz() + systEvent.jet2_.Pz(),
			   systEvent.jet1_.P()  + systEvent.jet2_.P() + newMet,systEvent.jet1_.Pt()  + systEvent.jet2_.Pt() + newMet};
	if     (which3rdl == 1) {pQQLN[0]+=systEvent.lep1_.Px();pQQLN[1]+=systEvent.lep1_.Py();pQQLN[2]+=systEvent.lep1_.Pz();pQQLN[3]+=systEvent.lep1_.P();pQQLN[4]+=systEvent.lep1_.Pt();}
	else if(which3rdl == 2) {pQQLN[0]+=systEvent.lep2_.Px();pQQLN[1]+=systEvent.lep2_.Py();pQQLN[2]+=systEvent.lep2_.Pz();pQQLN[3]+=systEvent.lep2_.P();pQQLN[4]+=systEvent.lep2_.Pt();}
	else if(which3rdl == 3) {pQQLN[0]+=systEvent.lep3_.Px();pQQLN[1]+=systEvent.lep3_.Py();pQQLN[2]+=systEvent.lep3_.Pz();pQQLN[3]+=systEvent.lep3_.P();pQQLN[4]+=systEvent.lep3_.Pt();}
	mQQLN  = pQQLN[3]*pQQLN[3]-pQQLN[0]*pQQLN[0]-pQQLN[1]*pQQLN[1]-pQQLN[2]*pQQLN[2]; if(mQQLN  > 0) mQQLN  = sqrt(mQQLN);  else mQQLN   = 0.0;
	mtQQLN = pQQLN[4]*pQQLN[4]-pQQLN[0]*pQQLN[0]-pQQLN[1]*pQQLN[1];                   if(mtQQLN > 0) mtQQLN = sqrt(mtQQLN); else mtQQLN  = 0.0;
      }
      bdtg = ((dRMin/4.0)-0.5)*2.0;if(bdtg >= 1.0) bdtg = 0.999; if(bdtg <= -1) bdtg = -0.999;
	 ...
	 passMode == true &&
      ...
      if(passCuts == true){
	double trigEff0 = trigLookup.GetExpectedTriggerEfficiency(fabs(systEvent.lep1_.Eta()), systEvent.lep1_.Pt() , 
     	 							  fabs(systEvent.lep2_.Eta()), systEvent.lep2_.Pt(), 
        							 TMath::Abs( systEvent.lid1_), TMath::Abs(systEvent.lid2_));
	double trigEff1 = trigLookup.GetExpectedTriggerEfficiency(fabs(systEvent.lep1_.Eta()), systEvent.lep1_.Pt() , 
     	 							  fabs(systEvent.lep3_.Eta()), systEvent.lep3_.Pt(), 
        							 TMath::Abs( systEvent.lid1_), TMath::Abs(systEvent.lid3_));
	double trigEff2 = trigLookup.GetExpectedTriggerEfficiency(fabs(systEvent.lep3_.Eta()), systEvent.lep3_.Pt() , 
     	 							  fabs(systEvent.lep2_.Eta()), systEvent.lep2_.Pt(), 
        							 TMath::Abs( systEvent.lid3_), TMath::Abs(systEvent.lid2_));
	double trigEff  = 1.0 - ((1.0-trigEff0)*(1.0-trigEff1)*(1.0-trigEff2));
	bool isRealLepton = false;
	...
	if(nFake == 1){
	    ...
	    add = add*nPUScaleFactor2012(fhDPUS4,(float)systEvent.npu_);
	    fDecay                 = 3;
	    theWeight              = +1.0 * systEvent.scale1fb_*lumi*add*trigEff;
	  }
	}
	...
	//else if(systEvent.dstype_ != SmurfTree::data){
          if(systEvent.dstype_ == SmurfTree::wz) add = 0.89;
	  add = add*nPUScaleFactor2012(fhDPUS4,(float)systEvent.npu_);
	  ...
	  // CAREFUL HERE, no data-driven corrections, just Higgs k-factors
	  // add = 1.0;
	  theWeight              = systEvent.scale1fb_*lumi*add*trigEff;
	}
	else {
          theWeight = 0.0;
	}
  ...
  if((channel >= 0 && channel <= 8000)){
	...
	if(
           ...
           sigEvent.njets_ >= 1 &&
	   massZMin < 20 &&
	   (sigEvent.jet1_+sigEvent.jet2_).M() > 40 && (sigEvent.jet1_+sigEvent.jet2_).M() < 150 &&
	   dRMin < 2.0 &&
	   1 == 1
	  ){
	  passCuts = true;
	...
	if(
      ...
      if(passCuts == true){
	double trigEff0 = trigLookup.GetExpectedTriggerEfficiency(fabs(sigEvent.lep1_.Eta()), sigEvent.lep1_.Pt() , 
     	 							  fabs(sigEvent.lep2_.Eta()), sigEvent.lep2_.Pt(), 
        							 TMath::Abs( sigEvent.lid1_), TMath::Abs(sigEvent.lid2_));
	double trigEff1 = trigLookup.GetExpectedTriggerEfficiency(fabs(sigEvent.lep1_.Eta()), sigEvent.lep1_.Pt() , 
     	 							  fabs(sigEvent.lep3_.Eta()), sigEvent.lep3_.Pt(), 
        							 TMath::Abs( sigEvent.lid1_), TMath::Abs(sigEvent.lid3_));
	double trigEff2 = trigLookup.GetExpectedTriggerEfficiency(fabs(sigEvent.lep3_.Eta()), sigEvent.lep3_.Pt() , 
     	 							  fabs(sigEvent.lep2_.Eta()), sigEvent.lep2_.Pt(), 
        							 TMath::Abs( sigEvent.lid3_), TMath::Abs(sigEvent.lid2_));
	double trigEff  = 1.0 - ((1.0-trigEff0)*(1.0-trigEff1)*(1.0-trigEff2));

	double add = 1.;
	add = add*nPUScaleFactor2012(fhDPUS4,(float)sigEvent.npu_);
	...
	if(channel == 1200 && bgdEvent.dstype_ == SmurfTree::wgstar) add = add*WGstarScaleFactor(systEvent.type_,systEvent.met_);
	double theWeight = sigEvent.scale1fb_*lumi*add*trigEff;
	...
	else if(thePlot ==45) myVar = sigEvent.jet1Btag_;
	else if(thePlot ==46) myVar = ptlw;
	else if(thePlot ==47) myVar = mTFromW;
	else if(thePlot ==48) myVar = type3l;
	...
	else if(thePlot ==54) myVar = sigEvent.pTrackMet_;
  ...
  if(signalInputFile2 != "" && isFermioPhobic == false && channel != 1102){
    ...
    double pxzll = ttEvent.dilep_.Px() + newMet*cos( ttEvent.metPhi_);
    double pyzll = ttEvent.dilep_.Py() + newMet*sin( ttEvent.metPhi_);
    double mtHZZ = TMath::Power(sqrt(ttEvent.dilep_.Pt()*ttEvent.dilep_.Pt()+91.1876*91.1876)+
                              sqrt(newMet       *newMet       +91.1876*91.1876),2)
		 -pxzll*pxzll-pyzll*pyzll;
    if(mtHZZ >0) mtHZZ = sqrt(mtHZZ); else mtHZZ = 0.0;
    double mtHWW = TMath::Power(sqrt(ttEvent.dilep_.Pt()*ttEvent.dilep_.Pt()+ttEvent.dilep_.M()*ttEvent.dilep_.M())+
                                sqrt(newMet       *newMet       +ttEvent.dilep_.M()*ttEvent.dilep_.M()),2)
		 -pxzll*pxzll-pyzll*pyzll;
    if(mtHWW >0) mtHWW = sqrt(mtHWW); else mtHWW = 0.0;

    double pznunu = 91.1876*91.1876 - newMet*newMet;
    if(pznunu > 0) pznunu = sqrt(pznunu); else pznunu = 0.0;
    double mHZZ = (sqrt(ttEvent.dilep_.P()*ttEvent.dilep_.P()+ttEvent.dilep_.M()*ttEvent.dilep_.M())+91.1876)*
                  (sqrt(ttEvent.dilep_.P()*ttEvent.dilep_.P()+ttEvent.dilep_.M()*ttEvent.dilep_.M())+91.1876)-
                 -pxzll*pxzll-pyzll*pyzll-(ttEvent.dilep_.Pz()+pznunu)*(ttEvent.dilep_.Pz()+pznunu);
    if(mHZZ > 0) mHZZ = sqrt(mHZZ); else mHZZ = 0.001;
    ...
    if(ttEvent.lid3_ != 0){
      ...
      dRMin = trilepton_info(2,ttEvent.lep1_,ttEvent.lep2_,ttEvent.lep3_,
		                  ...
		                  ttEvent.lid1_,ttEvent.lid2_,ttEvent.lid3_,
				  ttEvent.mt1_ ,ttEvent.mt2_ ,ttEvent.mt3_);
      mTW3  = trilepton_info(3,ttEvent.lep1_,ttEvent.lep2_,ttEvent.lep3_,
                                  ttEvent.lq1_ ,ttEvent.lq2_ ,ttEvent.lq3_,
		                  ttEvent.lid1_,ttEvent.lid2_,ttEvent.lid3_,
				  ttEvent.mt1_ ,ttEvent.mt2_ ,ttEvent.mt3_);
    ...
    if(passCuts == true){
      double trigEff0 = trigLookup.GetExpectedTriggerEfficiency(fabs(ttEvent.lep1_.Eta()), ttEvent.lep1_.Pt() , 
     	 							fabs(ttEvent.lep2_.Eta()), ttEvent.lep2_.Pt(), 
        						       TMath::Abs( ttEvent.lid1_), TMath::Abs(ttEvent.lid2_));
      double trigEff1 = trigLookup.GetExpectedTriggerEfficiency(fabs(ttEvent.lep1_.Eta()), ttEvent.lep1_.Pt() , 
     	 							fabs(ttEvent.lep3_.Eta()), ttEvent.lep3_.Pt(), 
        						       TMath::Abs( ttEvent.lid1_), TMath::Abs(ttEvent.lid3_));
      double trigEff2 = trigLookup.GetExpectedTriggerEfficiency(fabs(ttEvent.lep3_.Eta()), ttEvent.lep3_.Pt() , 
     	 							fabs(ttEvent.lep2_.Eta()), ttEvent.lep2_.Pt(), 
        						       TMath::Abs( ttEvent.lid3_), TMath::Abs(ttEvent.lid2_));
      double trigEff  = 1.0 - ((1.0-trigEff0)*(1.0-trigEff1)*(1.0-trigEff2));
      double add = 1.;
      /*
      add = add*nPUScaleFactor2012(fhDPUS4,(float)ttEvent.npu_);
      ...
      */
      ...
      if(channel == 1200) add = add*WGstarScaleFactor(ttEvent.type_,ttEvent.met_);
      double theWeight = ttEvent.scale1fb_*lumi*add*trigEff;
	...
	histo_WH_htt_CMS_MVAMETResBoundingUp  ->Fill(TMath::Max(TMath::Min((double)bdtg_aux2,maxHis-0.001),minHis+0.001), theWeight);
      ...
      else if(thePlot ==45) myVar = ttEvent.jet1Btag_;
      else if(thePlot ==46) myVar = ptlw;
      else if(thePlot ==47) myVar = mTFromW;
      else if(thePlot ==48) myVar = type3l;
      ...
      else if(thePlot ==54) myVar = ttEvent.pTrackMet_;
      histos->Fill(myVar,theWeight);
  ...
  for (int i=0; i<nData; ++i) {
    ...
    if(channel == 700){ // HZ->qqlnll selection
      ...
      if(
         ...
         dataEvent.njets_ >= 1 &&
	 massZMin < 20 &&
	 (dataEvent.jet1_+dataEvent.jet2_).M() > 40 && (dataEvent.jet1_+dataEvent.jet2_).M() < 150 &&
	 dRMin < 2.0 &&
	 1 == 1
	){
	passCuts = true;
    ...
    if(passCuts == true){
      ...
      else if(thePlot ==45) myVar = dataEvent.jet1Btag_;
      else if(thePlot ==46) myVar = ptlw;
      else if(thePlot ==47) myVar = mTFromW;
      else if(thePlot ==48) myVar = type3l;
      ...
      else if(thePlot ==54) myVar = dataEvent.pTrackMet_;
  ...
  if(makeGoodPlots){
    char output[200];
    sprintf(output,"histo_nice8.root");     
  ...
  if(fillInfoNote == true){
    ...
    if(channel == 1100 || channel == 1102){
      if     (channel == 1100) sprintf(outputLimitsCut,"histo_limits_vh3l%d_mh%3.0f_cut_8TeV.txt",nsel,mhAna);
      else if(channel == 1102) sprintf(outputLimitsCut,"histo_limits_zh3l2q_mh%3.0f_cut_8TeV.txt",mhAna);
      else assert(0);
      ofstream newcardCut;
      ...
      newcardCut << Form("bin 1 1 1 1 1 1 1\n");
      newcardCut << Form("process WH_htt WH_hww WZ ZZ Wjets Wgamma VVV\n");
      newcardCut << Form("process -1 0 1 2 3 4 5\n");
      newcardCut << Form("rate %6.3f %6.3f  %6.3f  %6.3f  %6.3f  %6.3f  %6.3f\n",nSigCut[6],nSigCut[0],bgdDecay[27],bgdDecay[28],bgdCombined[0],bgdCombined[3],bgdDecay[21]);
      newcardCut << Form("lumi_8TeV                  lnN 1.045 1.045	  -   1.045   -	  1.045   1.045\n");			  
      newcardCut << Form("CMS_eff_m                  lnN 1.040 1.040	  -   1.040   -	  1.040   1.040\n");			  
      newcardCut << Form("CMS_eff_e                  lnN 1.040 1.040	  -   1.040   -	  1.040   1.040\n");			  
      newcardCut << Form("CMS_p_scale_m              lnN 1.015 1.015	  -   1.015   -	  1.015   1.015\n");			  
      newcardCut << Form("CMS_p_scale_e              lnN 1.020 1.020	  -   1.020   -	  1.020   1.020\n");			  
      newcardCut << Form("CMS_res_met                lnN %5.3f %5.3f      -   %5.3f   -	  %5.3f   %5.3f\n",CMS_met,CMS_met,CMS_met,CMS_met,CMS_met);
      newcardCut << Form("CMS_res_j                  lnN %5.3f %5.3f    %5.3f %5.3f   -   %5.3f   %5.3f\n",CMS_jes,CMS_jes,CMS_jes_WZ,CMS_jes_ZZ,CMS_jes,CMS_jes);
      newcardCut << Form("CMS_vh3l_pu                lnN 1.010 1.010      -   1.010   -   1.010   1.010\n");		     
      newcardCut << Form("FakeRate                   lnN   -	  -	  -     -   1.400   -       -  \n");
      newcardCut << Form("UEPS                       lnN 1.030 1.030	  -     -     -	    -       -  \n");
      newcardCut << Form("pdf_qqbar                  lnN %5.3f %5.3f    1.015 1.040   -	  1.300   1.500\n",PDF_VH,PDF_VH);
      newcardCut << Form("QCDscale_VH                lnN %5.3f %5.3f	  -     -     -	    -       -  \n",QCDscale_VH,QCDscale_VH);	       
      newcardCut << Form("CMS_vh3l_WZ_8TeV           lnN   -	 -     1.090    -     -     -       -  \n");	       
      newcardCut << Form("CMS_vh3l_stat_WH_htt_8TeV  lnN %5.3f   -	 -      -     -     -       -  \n",signalError[1]);	
      newcardCut << Form("CMS_vh3l_stat_WH_hww_8TeV  lnN   -   %5.3f	 -      -     -     -       -  \n",signalError[0]);	
      newcardCut << Form("CMS_vh3l_stat_WZ_8TeV      lnN   -	 -     %5.3f    -     -     -       -  \n",weiDecay[27]+1.0);	
      newcardCut << Form("CMS_vh3l_stat_ZZ_8TeV      lnN   -	 -	 -    %5.3f   -     -       -  \n",weiDecay[28]+1.0);
      newcardCut << Form("CMS_vh3l_stat_Wjets_8TeV   lnN   -	 -	 -      -   %5.3f   -       -  \n",bgdCombinedE[0]+1.0);
      newcardCut << Form("CMS_vh3l_stat_Wgamma_8TeV  lnN   -	 -	 -      -     -   %5.3f     -  \n",bgdCombinedE[3]+1.0);
      newcardCut << Form("CMS_vh3l_stat_VVV_8TeV     lnN   -	 -	 -      -     -     -     %5.3f\n",weiDecay[21]+1.0);
    }
    ...
    if(channel == 1101){
      ...
      // Systematics Shapes
      //----------------------------------------------------------------------------
      if(histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVUp->GetNbinsX() != histo_WH_htt->GetNbinsX()) {printf("PROBLEMMMMM\n");return;}
	...
	if(useAlternativeStatTemplates == true){
	  if     (i<1.0*histo_WH_htt->GetNbinsX()/3.0) {factorUp = -1.0; factorDown = +1.0;}
    	...
    	histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVUp	     ->SetBinContent(i,TMath::Max(histo_WH_htt   ->GetBinContent(i)+factorUp  *histo_WH_htt  ->GetBinError(i),0.000001));
    	histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVDown       ->SetBinContent(i,TMath::Max(histo_WH_htt   ->GetBinContent(i)+factorDown*histo_WH_htt  ->GetBinError(i),0.000001));
    	histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVUp	     ->SetBinContent(i,TMath::Max(histo_WH_hww   ->GetBinContent(i)+factorUp  *histo_WH_hww  ->GetBinError(i),0.000001));
    	histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVDown       ->SetBinContent(i,TMath::Max(histo_WH_hww   ->GetBinContent(i)+factorDown*histo_WH_hww  ->GetBinError(i),0.000001));
    	histo_WZ_CMS_MVAWZStatBounding_8TeVUp	     ->SetBinContent(i,TMath::Max(histo_WZ     ->GetBinContent(i)+factorUp  *histo_WZ    ->GetBinError(i),0.000001));
    	histo_WZ_CMS_MVAWZStatBounding_8TeVDown           ->SetBinContent(i,TMath::Max(histo_WZ     ->GetBinContent(i)+factorDown*histo_WZ    ->GetBinError(i),0.000001));
    	histo_ZZ_CMS_MVAZZStatBounding_8TeVUp	     ->SetBinContent(i,TMath::Max(histo_ZZ     ->GetBinContent(i)+factorUp  *histo_ZZ    ->GetBinError(i),0.000001));
    	histo_ZZ_CMS_MVAZZStatBounding_8TeVDown           ->SetBinContent(i,TMath::Max(histo_ZZ     ->GetBinContent(i)+factorDown*histo_ZZ    ->GetBinError(i),0.000001));
    	...
    	histo_VVV_CMS_MVAVVVStatBounding_8TeVUp	     ->SetBinContent(i,TMath::Max(histo_VVV  ->GetBinContent(i)+factorUp  *histo_VVV ->GetBinError(i),0.000001));
    	histo_VVV_CMS_MVAVVVStatBounding_8TeVDown     ->SetBinContent(i,TMath::Max(histo_VVV  ->GetBinContent(i)+factorDown*histo_VVV ->GetBinError(i),0.000001));
      }
      for(int i=1; i<=histo_WH_htt->GetNbinsX(); i++){	 
      ...
      sprintf(outputLimits,"vh3l%d_%3d.input_8TeV.root",nsel,(int)mhAna);     
      ...
      cout << histo_VVV->GetSumOfWeights()     << endl;
      histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVUp  ->Write();
      histo_WH_htt_CMS_MVAWH_httStatBounding_8TeVDown->Write();
      histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVUp  ->Write();
      histo_WH_hww_CMS_MVAWH_hwwStatBounding_8TeVDown->Write();
      histo_WZ_CMS_MVAWZStatBounding_8TeVUp  	     ->Write();
      histo_WZ_CMS_MVAWZStatBounding_8TeVDown	     ->Write();
      histo_ZZ_CMS_MVAZZStatBounding_8TeVUp  	     ->Write();
      histo_ZZ_CMS_MVAZZStatBounding_8TeVDown	     ->Write();
      ...
      histo_VVV_CMS_MVAVVVStatBounding_8TeVUp        ->Write();
      histo_VVV_CMS_MVAVVVStatBounding_8TeVDown      ->Write();
      ...
      sprintf(outputLimitsShape,"histo_limits_vh3l%d_mh%3.0f_shape_8TeV.txt",nsel,mhAna);     
      ...
      newcardShape << Form("bin 1 1 1 1 1 1 1\n");
      newcardShape << Form("process WH_htt WH_hww WZ ZZ Wjets Wgamma VVV\n");
      newcardShape << Form("process -1 0 1 2 3 4 5\n");
      newcardShape << Form("rate %6.3f %6.3f  %6.3f  %6.3f  %6.3f  %6.3f  %6.3f\n",nSigCut[6],nSigCut[0],bgdDecay[27],bgdDecay[28],bgdCombined[0],bgdCombined[3],bgdDecay[21]);
      newcardShape << Form("lumi_8TeV				   lnN   1.045 1.045   -   1.045   -   1.045   1.045\n");		       
      newcardShape << Form("CMS_MVALepEffBounding		 shape     %s  1.000 1.000 1.000   -     %s    1.000\n",theWH_httString,theWH_WgammaString);		  
      newcardShape << Form("CMS_p_scale_m			   lnN   1.015 1.015   -   1.015   -   1.015   1.015\n");		
      newcardShape << Form("CMS_p_scale_e			   lnN   1.020 1.020   -   1.020   -   1.020   1.020\n");		
      newcardShape << Form("CMS_res_met 			   lnN   %5.3f %5.3f   -   %5.3f   -   %5.3f   %5.3f\n",CMS_met,CMS_met,CMS_met,CMS_met,CMS_met);
      newcardShape << Form("CMS_MVAJESBounding  		 shape     %s  1.000 1.000 1.000   -     %s    1.000\n",theWH_httString,theWH_WgammaString);			
      newcardShape << Form("CMS_vh3l_pu 			   lnN   1.010 1.010   -   1.010   -   1.000   1.000\n");		    
      ...
      newcardShape << Form("pdf_qqbar				   lnN   %5.3f %5.3f 1.015 1.040   -	1.300  1.500\n",PDF_VH,PDF_VH);
      newcardShape << Form("QCDscale_VH 			   lnN   %5.3f %5.3f   -     -     -	 -	 -  \n",QCDscale_VH,QCDscale_VH);			  
      newcardShape << Form("CMS_vh3l_WZ_8TeV			   lnN     -	 -   1.090   -     -	 -	 -  \n");
      if(histo_WH_htt->GetSumOfWeights() > 0)	 
      newcardShape << Form("CMS_MVAWH_httStatBounding_8TeV_vh3l  shape   1.000   -     -     -     -	 -	 -  \n");
      newcardShape << Form("CMS_MVAWH_hwwStatBounding_8TeV_vh3l  shape     -   1.000   -     -     -	 -	 -  \n");
      newcardShape << Form("CMS_MVAWZStatBounding_8TeV_vh3l	 shape     -	 -    1.000  -     -	 -	 -  \n");
      newcardShape << Form("CMS_MVAZZStatBounding_8TeV_vh3l	 shape     -	 -	-   1.000  -	 -	 -  \n");
      newcardShape << Form("CMS_MVAWjetsStatBounding_8TeV_vh3l   shape     -	 -	-    -   1.000   -	 -  \n");
      if(histo_Wgamma->GetSumOfWeights() > 0)
      newcardShape << Form("CMS_MVAWgammaStatBounding_8TeV_vh3l  shape     -	 -	-    -     -    1.000    -  \n");
      newcardShape << Form("CMS_MVAVVVStatBounding_8TeV_vh3l     shape     -	 -	-    -     -     -     1.000\n");
    }
  }
}
