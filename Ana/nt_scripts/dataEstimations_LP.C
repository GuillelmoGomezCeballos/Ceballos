...
// dataEstimations_LP
//------------------------------------------------------------------------------
void dataEstimations_LP
(
 int     mH  	 = 5,
 double mhAna = 4,
 TString bgdInputFile    = "ntuples_42x_LP/background42x_METVeto_ZVeto.root",
 TString signalInputFile = "ntuples_42x_LP/hww160.root",
 TString dataInputFile   = "ntuples_42x_LP/data_2l_METVeto_ZVeto.root"
 )
{
