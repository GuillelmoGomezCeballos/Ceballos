 ...
 )
{
  ...
  sprintf(title,"data/inputNtuple-train-data-standard-H%d_WW_2l.root",mhiggs);
  TString sigFile1 = title;

  TString bgdFile1 = "data/inputNtuple-data-standard-HBCK_WW_2l-train.root";

  sprintf(title,"proc/inputNtuple-train-data-standard-H%d_WW_2l.%d.0jets.tmva.root",mhiggs,mhiggs);
  TString sigFile2 = title;

  sprintf(title,"proc/inputNtuple-data-standard-HBCK_WW_2l-train.%d.0jets.tmva.root",mhiggs);
  TString bgdFile2 = title;
  ...
  for (int i=0; i<nSig; ++i) {
    ...
    sigMLP_0->Fill(mlp_0,weight);
    sigMLP_1->Fill(mlp_1,weight);
    sigMLP_2->Fill(mlp_2,weight);
    sigMLP_3->Fill(mlp_3,weight);
    sigMLP_4->Fill(mlp_4,weight);
    sigMLP_5->Fill(mlp_5,weight);
    sigMLP_6->Fill(mlp_6,weight);
  }
  ...
  for (int i=0; i<nBgd; ++i) {
    ...
    bgdAllMLP_0->Fill(mlp_0,weight);
    bgdAllMLP_1->Fill(mlp_1,weight);
    bgdAllMLP_2->Fill(mlp_2,weight);
    bgdAllMLP_3->Fill(mlp_3,weight);
    bgdAllMLP_4->Fill(mlp_4,weight);
    bgdAllMLP_5->Fill(mlp_5,weight);
    bgdAllMLP_6->Fill(mlp_6,weight);
  }
  ...
  setGraph(gBDT  , 1, 20);
  setGraph(gMLP_0, 2, 21);
  setGraph(gMLP_1, 3, 22);
  setGraph(gMLP_2, 4, 23);
  setGraph(gMLP_3, 5, 24);
  setGraph(gMLP_4, 6, 25);
  setGraph(gMLP_5, 7, 26);
  setGraph(gMLP_6, 8, 27);
