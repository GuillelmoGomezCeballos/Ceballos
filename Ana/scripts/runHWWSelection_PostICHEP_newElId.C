// $Id: runHWWSelection_PostICHEP_newElId.C,v 1.2 2012/09/10 09:32:29 ceballos Exp $
...
//--------------------------------------------------------------------------------------------------
void runHWWSelection(const char *catalogDir   = "/home/mitprod/catalog",
		     const char *book	      = "cern/filefi/015",
                     const char *dataset      = "f10-ww2l-z2-v12",
                     const char *fileset      = "0000",
                     int nsel = 220, int NEvents = 1000000)
{
  ...
  if     (nsel ==  1){
    fDecay = 110; theMH = 110; theWidth =  2.82e-03;
  }
  else if(nsel ==  2){
    fDecay = 1110; theMH = 110; theWidth =  2.82e-03;
  }
  else if(nsel ==  3){
    fDecay = 115; theMH = 115; theWidth =  3.09e-03;
  }
  else if(nsel ==  4){
    fDecay = 1115; theMH = 115; theWidth =  3.09e-03;
  }
  else if(nsel ==  5){
    fDecay = 120; theMH = 120; theWidth =  3.47e-03;
  }
  else if(nsel ==  6){
    fDecay = 1120; theMH = 120; theWidth =  3.47e-03;
  }
  else if(nsel ==  7){
    fDecay = 125; theMH = 125; theWidth =  4.03e-03;
  }
  else if(nsel ==  8){
    fDecay = 1125; theMH = 125; theWidth =  4.03e-03;
  }
  else if(nsel ==  9){
    fDecay = 130; theMH = 130; theWidth =  4.87e-03;
  }
  else if(nsel == 10){
    fDecay = 1130; theMH = 130; theWidth =  4.87e-03;
  }
  else if(nsel == 11){
    fDecay = 135; theMH = 135; theWidth =  6.14e-03;
  }
  else if(nsel == 12){
    fDecay = 1135; theMH = 135; theWidth =  6.14e-03;
  }
  else if(nsel == 13){
    fDecay = 140; theMH = 140; theWidth =  8.12e-03;
  }
  else if(nsel == 14){
    fDecay = 1140; theMH = 140; theWidth =  8.12e-03;
  }
  else if(nsel == 15){
    fDecay = 145; theMH = 145; theWidth =  1.14e-02;
  }
  else if(nsel == 16){
    fDecay = 1145; theMH = 145; theWidth =  1.14e-02;
  }
  else if(nsel == 17){
    fDecay = 150; theMH = 150; theWidth =  1.73e-02;
  }
  else if(nsel == 18){
    fDecay = 1150; theMH = 150; theWidth =  1.73e-02;
  }
  else if(nsel == 19){
    fDecay = 155; theMH = 155; theWidth =  3.02e-02;
  }
  else if(nsel == 20){
    fDecay = 1155; theMH = 155; theWidth =  3.02e-02;
  }
  else if(nsel == 21){
    fDecay = 160; theMH = 160; theWidth =  8.29e-02;
  }
  else if(nsel == 22){
    fDecay = 1160; theMH = 160; theWidth =  8.29e-02;
  }
  else if(nsel == 23){
    fDecay = 170; theMH = 170; theWidth =  3.80e-01;
  }
  else if(nsel == 24){
    fDecay = 1170; theMH = 170; theWidth =  3.80e-01;
  }
  else if(nsel == 25){
    fDecay = 180; theMH = 180; theWidth =  6.31e-01;
  }
  else if(nsel == 26){
    fDecay = 1180; theMH = 180; theWidth =  6.31e-01;
  }
  else if(nsel == 27){
    fDecay = 190; theMH = 190; theWidth =  1.04e+00;
  }
  else if(nsel == 28){
    fDecay = 1190; theMH = 190; theWidth =  1.04e+00;
  }
  else if(nsel == 29){
    fDecay = 200; theMH = 200; theWidth =  1.43e+00;
  }
  else if(nsel == 30){
    fDecay = 1200; theMH = 200; theWidth =  1.43e+00;
  }
  else if(nsel == 31){
    fDecay = 250; theMH = 250; theWidth =  4.04e+00;
  }
  else if(nsel == 32){
    fDecay = 1250; theMH = 250; theWidth =  4.04e+00;
  }
  else if(nsel == 33){
    fDecay = 300; theMH = 300; theWidth =  8.43e+00;
  }
  else if(nsel == 34){
    fDecay = 1300; theMH = 300; theWidth =  8.43e+00;
  }
  else if(nsel == 35){
    fDecay = 350; theMH = 350; theWidth =  1.52e+01;
  }
  else if(nsel == 36){
    fDecay = 1350; theMH = 350; theWidth =  1.52e+01;
  }
  else if(nsel == 37){
    fDecay = 400; theMH = 400; theWidth =  2.92e+01;
  }
  else if(nsel == 38){
    fDecay = 1400; theMH = 400; theWidth =  2.92e+01;
  }
  else if(nsel == 39){
    fDecay = 450; theMH = 450; theWidth =  4.69e+01;
  }
  else if(nsel == 40){
    fDecay = 1450; theMH = 450; theWidth =  4.69e+01;
  }
  else if(nsel == 41){
    fDecay = 500; theMH = 500; theWidth =  6.80e+01;
  }
  else if(nsel == 42){
    fDecay = 1500; theMH = 500; theWidth =  6.80e+01;
  }
  else if(nsel == 43){
    fDecay = 550; theMH = 550; theWidth =  9.31e+01;
  }
  else if(nsel == 44){
    fDecay = 1550; theMH = 550; theWidth =  9.31e+01;
  }
  else if(nsel == 45){
    fDecay = 600; theMH = 600; theWidth =  1.23e+02;
  }
  else if(nsel == 46){
    fDecay = 1600; theMH = 600; theWidth =  1.23e+02;
  }
  else if(nsel == 47){
    fDecay = 700; theMH = 700; theWidth =  1.99E+02;
  }
  else if(nsel == 48){
    fDecay = 1700; theMH = 700; theWidth =  1.99E+02;
  }
  else if(nsel == 49){
    fDecay = 800; theMH = 800; theWidth =  3.04E+02;
  }
  else if(nsel == 50){
    fDecay = 1800; theMH = 800; theWidth =  3.04E+02;
  }
  else if(nsel == 51){
    fDecay = 900; theMH = 900; theWidth =  4.49E+02;
  }
  else if(nsel == 52){
    fDecay = 1900; theMH = 900; theWidth =  4.49E+02;
  }
  else if(nsel == 53){
    fDecay = 1000; theMH = 1000; theWidth =  6.47E+02;
  }
  else if(nsel == 54){
    fDecay = 2000; theMH = 1000; theWidth =  6.47E+02;
  }
  else if(nsel == 55){
    fDecay = 2110;
  }
    ...
    //files[0]   = "/castor/cern.ch/user/p/paus/filefi/027/s12-wwj-v9/A6DE4085-8191-E111-BF4E-001E67396D5B.root";
  ...
  if(isData == true && isDataDMuon == true) {
    ...
    hltmod->AddTrigger("!HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&HLT_Mu17_Mu8_v21"  ,199632,999999);
    hltmod->AddTrigger("!HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&HLT_Mu17_TkMu8_v13",199632,999999);
  }
  if(isData == true && isDataSMuon == true) {
    ...
    hltmod->AddTrigger("!HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu17_Mu8_v21&!HLT_Mu17_TkMu8_v13&HLT_IsoMu24_eta2p1_v15",199632,999999);
  }
  if(isData == true && isDataDElectron == true) {
    ...
    hltmod->AddTrigger("!HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu17_Mu8_v21&!HLT_Mu17_TkMu8_v13&!HLT_IsoMu24_eta2p1_v15&HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v18",199632,999999);
  }
  if(isData == true && isDataSElectron == true) {
    ...
    hltmod->AddTrigger("!HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9&!HLT_Mu17_Mu8_v21&!HLT_Mu17_TkMu8_v13&!HLT_IsoMu24_eta2p1_v15&!HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v18&HLT_Ele27_WP80_v11",199632,999999);
  }
  if(isData == false){
    if(nsel == 299) {
  ...
  TString rootFileHKF = TString("test/");
  ...
  muonIDBS->SetIDType(theWWId);
  muonIDBS->SetIsoType("PFIso");
  ...
  muonID1->SetIDType(theWWId);
  muonID1->SetIsoType("IsoRingsV0_BDTG_Iso");
  ...
  electronID1->SetIDType("MVA_BDTG_IDIsoCombinedHWW2012TrigV4");
  electronID1->SetIsoType("MVA_BDTG_IDIsoCombinedHWW2012TrigV4");
  ...
  electronID1->SetElectronMVAWeightsSubdet0Pt10To20 (string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/ElectronMVAWeights/ElectronIDMVA_Trig_V4_EtaBin0LowPt_V4_BDTG.weights.xml")));
  electronID1->SetElectronMVAWeightsSubdet1Pt10To20 (string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/ElectronMVAWeights/ElectronIDMVA_Trig_V4_EtaBin1LowPt_V4_BDTG.weights.xml")));
  electronID1->SetElectronMVAWeightsSubdet2Pt10To20 (string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/ElectronMVAWeights/ElectronIDMVA_Trig_V4_EtaBin2LowPt_V4_BDTG.weights.xml")));
  electronID1->SetElectronMVAWeightsSubdet0Pt20ToInf(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/ElectronMVAWeights/ElectronIDMVA_Trig_V4_EtaBin0HighPt_V4_BDTG.weights.xml")));
  electronID1->SetElectronMVAWeightsSubdet1Pt20ToInf(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/ElectronMVAWeights/ElectronIDMVA_Trig_V4_EtaBin1HighPt_V4_BDTG.weights.xml")));
  electronID1->SetElectronMVAWeightsSubdet2Pt20ToInf(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/ElectronMVAWeights/ElectronIDMVA_Trig_V4_EtaBin2HighPt_V4_BDTG.weights.xml")));
  ...
  if(is2011Corr == true) {
    ...
    jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START52_V9_L1FastJet_AK5PF.txt"))); 
    jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START52_V9_L2Relative_AK5PF.txt"))); 
    jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START52_V9_L3Absolute_AK5PF.txt")));
    if(isData == true){
      jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START52_V9_L2L3Residual_AK5PF.txt")));
    }
  }
  ...
  theJetID2_ntuple->SetApplyMVACut(kTRUE);
  ...
  WtnEvtSelMod *WtnEvtSelMod1 = new WtnEvtSelMod;
  WtnEvtSelMod1->SetCleanJetsName("CleanJetsNoPtCut_ntuple");
  WtnEvtSelMod1->SetPrintDebug(kFALSE);
  WtnEvtSelMod1->SetMetName(pubPFMet->GetOutputName());
  WtnEvtSelMod1->SetPFTaus0Name("ShrinkingConePFTaus");
  WtnEvtSelMod1->SetPFTaus1Name("HPSTaus");
  ...
  TString rootFileHwwMake3 = TString("test/");
  ...
  muonIDFakeable->SetIDType(theWWId);
  muonIDFakeable->SetIsoType("IsoRingsV0_BDTG_Iso");
  muonIDFakeable->SetApplyD0Cut(kTRUE);
  muonIDFakeable->SetApplyDZCut(kTRUE);
  muonIDFakeable->SetD0Cut(0.20);
  muonIDFakeable->SetPFIsoCut(-0.60);
  ...
  pubPFMet->Add(WtnEvtSelMod1);
  WtnEvtSelMod1->Add(muonIDFakeable);
