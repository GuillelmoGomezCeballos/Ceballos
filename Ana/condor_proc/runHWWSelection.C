// $Id: runHWWSelection.C,v 1.2 2012/10/16 18:59:12 ceballos Exp $
                     ...
                     int nsel = 620, int NEvents = 100)
{
  ...
  if     (nsel ==  1){
    ...
    files[0]   = "/castor/cern.ch/user/p/paus/filefi/029/s12-wglmm-v7a/9E90A540-C2DB-E111-A308-003048678B3C.root";
  ...
  if     (is2011Corr == true) {
    ...
    if     (isData == true){
      jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/GR_P_V41_AN2_L1FastJet_AK5PF.txt"))); 
      jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/GR_P_V41_AN2_L2Relative_AK5PF.txt"))); 
      jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/GR_P_V41_AN2_L3Absolute_AK5PF.txt")));
      if(isData == true){
        jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/GR_P_V41_AN2_L2L3Residual_AK5PF.txt")));
      }
    }
    else if(isData == false){
      jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START53_V7F_L1FastJet_AK5PF.txt"))); 
      jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START53_V7F_L2Relative_AK5PF.txt"))); 
      jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START53_V7F_L3Absolute_AK5PF.txt")));
      if(isData == true){
        jetCorr1_ntuple->AddCorrectionFromFile(string(getenv("CMSSW_BASE")+string("/src/MitPhysics/data/START53_V7F_L2L3Residual_AK5PF.txt")));
      }
    }
  }
